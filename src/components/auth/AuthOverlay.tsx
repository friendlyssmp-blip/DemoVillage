...
import { Mail, Lock, User, MapPin, Loader2, CheckCircle2, AlertCircle, LogIn, UserPlus, LogOut, RotateCw } from 'lucide-react';
            ...
            {step === 'login' && (
              ...
              >
                ...
                <button 
                  ...
                  disabled={loading}
                  className="w-full bg-white/5 border border-white/10 text-white font-black py-4 rounded-3xl uppercase italic tracking-widest text-xs hover:bg-white/10 transition-all flex items-center justify-center gap-3"
                >
                ...
                <p className="text-center text-[10px] font-bold text-white/30 uppercase tracking-widest mt-6">
                  New here? <button type="button" onClick={() => setStep('register')} className="text-blue-400 hover:text-blue-300">Create Account</button>
                </p>
              </motion.form>
            )}
            ...
            {step === 'register' && (
              ...
              >
                ...
                >
                  ...
                  {auth.currentUser ? 'Finish Setup' : 'Start Adventure'}
                </button>
